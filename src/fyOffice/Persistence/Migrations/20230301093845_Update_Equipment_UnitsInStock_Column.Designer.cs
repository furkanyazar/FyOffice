...
namespace Persistence.Migrations
{
    ...
    [Migration("20230301093845_Update_Equipment_UnitsInStock_Column")]
    partial class Update_Equipment_UnitsInStock_Column
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.EmployeeEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "EmployeeId", "EquipmentId" }, "UK_EmployeeEquipments_EmployeeId_EquipmentId")
                        .IsUnique();

                    b.ToTable("EmployeeEquipments", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Equipment", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UK_Equipments_Name")
                        .IsUnique();
